  ...
  'Hackathons & Case Comps': [
    {
      id: 1,
      title: 'Imperium',
      subtitle: 'The Strategy Case Competition',
      org: 'IIM Indore',
      date: 'Nov 2025',
      result: 'Top 300 / 5000+',
      resultColor: '#a78bfa',
      link: 'https://unstop.com/certificate-preview/ccec8c33-5165-437a-a50f-0b28ce8b4ef3?utm_campaign',
    },
    {
      id: 2,
      title: 'Productathon',
      subtitle: 'The Product Management Hackathon',
      org: 'IIT Roorkee',
      date: '6 Feb 2026',
      result: 'National Finalist · Top 30 / 400+',
      resultColor: '#06b6d4',
      link: 'https://certificate.givemycertificate.com/c/8727d68a-5a12-4412-97ec-fcf56e58f5d9',
    },
    {
      id: 3,
      title: 'DataForge',
      subtitle: 'The AI/ML Hackathon',
      org: 'IIT Roorkee',
      date: '7 Feb 2026',
      result: 'National Finalist · Top 30 / 500+',
      resultColor: '#f472b6',
      link: 'https://certificate.givemycertificate.com/c/16080abe-3d73-4815-ace3-98b2ef3027b5',
    },
  ],
  'Professional': [
    {
      ...
      result: 'Certified',
      resultColor: '#34d399',
      link: 'https://certx.in/certificate/36a28147-6eed-47a5-8342-e5f926ebba611113870',
    },
  ],
}
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
        <span style={{ fontFamily: 'var(--font-body)', fontSize: '0.75rem', fontWeight: 600, color: color }}>{cert.org}</span>
      ...
      <a href={cert.link} target="_blank" rel="noreferrer"
        style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', padding: '0.5rem 1rem', fontFamily: 'var(--font-body)', fontSize: '0.72rem', fontWeight: 600, color: color, background: `${color}12`, border: `1px solid ${color}35`, borderRadius: '8px', textDecoration: 'none', cursor: 'none', transition: 'all 0.2s', alignSelf: 'flex-start' }}
...
export default function Certifications() {
  ...
  return (
    <section id="certifications" ref={ref} style={{ position: 'relative', padding: isMobile ? '4rem 0' : '8rem 0', background: '#04040f', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto', padding: isMobile ? '0 1.25rem' : isTablet ? '0 2rem' : '0 4rem' }}>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6, delay: 0.15, ease: [0.22,1,0.36,1] as const }} style={{ display: 'flex', gap: '0.6rem', marginBottom: '2.5rem', flexWrap: 'wrap' }}>
          {(Object.keys(certData) as Tab[]).map(t => (
            <button key={t} onClick={() => setTab(t)} style={{ padding: '0.5rem 1.4rem', borderRadius: '999px', fontFamily: 'var(--font-body)', fontSize: isMobile ? '0.78rem' : '0.85rem', fontWeight: 500, border: `1px solid ${tab === t ? tabColors[t] + '77' : 'rgba(255,255,255,0.08)'}`, background: tab === t ? `${tabColors[t]}1a` : 'transparent', color: tab === t ? tabColors[t] : '#64748b', cursor: 'none', transition: 'all 0.3s', boxShadow: tab === t ? `0 0 20px ${tabColors[t]}22` : 'none' }}>
              {t}
            </button>
          ))}
        </motion.div>
      ...
      {/* Drag hint */}
      <div style={{ maxWidth: '1100px', margin: '0 auto', padding: isMobile ? '0 1.25rem' : '0 4rem', marginBottom: '0.75rem' }}>
      ...
      <motion.div initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} transition={{ duration: 0.6, delay: 0.3 }}>
        <div
          ...
          style={{ display: 'flex', gap: '1.1rem', overflowX: 'auto', overflowY: 'visible', padding: isMobile ? '1rem 1.25rem 2rem' : '1rem 4rem 2rem', scrollbarWidth: 'none', cursor: 'grab', userSelect: 'none', WebkitOverflowScrolling: 'touch' } as React.CSSProperties}
        >
