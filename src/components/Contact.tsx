...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={ref} style={{ position: 'relative', padding: '8rem 0 6rem', background: '#04040f', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 4rem' }}>
          ...
          >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
              <div>
                ...
                <input
                  ...
                  style={{ ...inputStyle('name'), boxSizing: 'border-box' }}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  style={{ ...inputStyle('email'), boxSizing: 'border-box' }}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="Project type, collaboration, internship..."
                onFocus={() => setFocused('subject')} onBlur={() => setFocused(null)}
                style={{ ...inputStyle('subject'), boxSizing: 'border-box' }}
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Tell me what you're working on, what you need help with, or just drop a hello. I read every message."
                rows={6}
                onFocus={() => setFocused('message')} onBlur={() => setFocused(null)}
                style={{ ...inputStyle('message'), resize: 'vertical', boxSizing: 'border-box' } as React.CSSProperties}
              />
            </div>
            ...
            <motion.button
              ...
              style={{
                ...
                boxShadow: '0 0 28px rgba(124,58,237,0.4), inset 0 1px 0 rgba(255,255,255,0.1)',
            ...
            >
              {status === 'sending' ? (
                <>
                  <motion.span animate={{ rotate: 360 }} transition={{ repeat: Infinity, duration: 0.8, ease: 'linear' }} style={{ display: 'inline-block', width: '14px', height: '14px', border: '2px solid rgba(255,255,255,0.3)', borderTopColor: '#fff', borderRadius: '50%' }} />
                  Sending...
                </>
              ) : status === 'sent' ? (
                <>✓ Message Sent!</>
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
              ...
              <div>
                ...
                <a href="mailto:om.25741@sscbs.du.ac.in" style={{ fontFamily: 'var(--font-body)', fontSize: '0.82rem', color: '#a78bfa', textDecoration: 'none', transition: 'color 0.2s' }}
                  onMouseEnter={e => (e.currentTarget as HTMLElement).style.color = '#c4b5fd'}
                  onMouseLeave={e => (e.currentTarget as HTMLElement).style.color = '#a78bfa'}
                >
                  om.25741@sscbs.du.ac.in
                </a>
              </div>
            </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                {socials.map(s => (
                  ...
                  >
                    ...
                    <svg style={{ marginLeft: 'auto', color: '#334155' }} width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <motion.div
          ...
          style={{ textAlign: 'center', marginTop: '6rem', paddingTop: '2rem', borderTop: '1px solid rgba(255,255,255,0.05)' }}
        >
          <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.78rem', color: '#1e293b' }}>
            Designed by Om Parida · Built with Next.js + Three.js
          </p>
        </motion.div>
      </div>
    </section>
